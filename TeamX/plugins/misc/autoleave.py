...
from TeamSky.core.call import TeamSky, autoend, counter
from TeamSky.utils.database import get_client, set_loop, is_active_chat, is_autoend, is_autoleave
import logging
    ...
    while True:
        ...
        try:
            ...
            for chat_id in chatss:
                try:
                    users = len(await TeamSky.call_listeners(chat_id))
