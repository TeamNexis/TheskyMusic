...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("TeamSky/assets/font2.ttf", 30)
        font = ImageFont.truetype("TeamSky/assets/font.ttf", 30)
        title_font = ImageFont.truetype("TeamSky/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("TeamSky/assets/play_icons.png")
